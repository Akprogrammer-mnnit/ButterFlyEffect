...
function activate(context) {
    /* eslint-disable */ console.log(...oo_oo(`3235312410_82_1_82_57_4`, 'Butterfly Effect extension is now active!'));
    ...
    const analyzeCommand = vscode.commands.registerCommand('butterfly.analyzeFunction', async (functionId, functionCode) => {
        vscode.window.withProgress({
            ...
            try {
                /* eslint-disable */ console.log(...oo_oo(`3235312410_98_5_98_57_4`, `Analyzing impact for ${functionId}...`));
                const response = await axios_1.default.post('http://localhost:5555/api/impact/analyze', {
                    targetFunctionIds: [functionId],
                    code: functionCode
                });
                /* eslint-disable */ console.log(...oo_oo(`3235312410_104_5_104_71_4`, `Received response for ${functionId}:`, response.data));
                ...
                /* eslint-disable */ console.error(...oo_tx(`3235312410_115_5_115_25_11`, error));
            }
        });
    });
